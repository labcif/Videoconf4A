...
if __name__ == "__main__":
    ...
    if decrypted_local_state_key["status"] == "KO":
        print(json.dumps(decrypted_local_state_key))
        exit(1)

    decrypt_chromium = DecryptChromium(decrypted_local_state_key["decrypted_blob"], output_dir)
    decrypt_chromium.decypher_cookies(cookies_file)
    decrypt_chromium.decrypt_login_data(login_data_file)